...
public class DiasRestantes01 {
	public static void main(String[] args) {
		...
		MesesAno ma = (MesesAno) JOptionPane.showInputDialog(null, "Selecione o mês", "Meses",
				JOptionPane.QUESTION_MESSAGE, null, MesesAno.values(), MesesAno.MARÇO);

		int mes = ma.ordinal();// retorna a posição de acordo com a ordem
